...
if __name__ == "__main__":
    ...
    eval_dataset = EvalDataset(img_root='./ckpt/run1/Salmaps/', gt_root='./Dataset/iCoSeg/GroundTruth/')
    ...
    evaler = Eval(img_root='./ckpt/run1/Salmaps/', label_root='./Dataset/iCoSeg/GroundTruth')
